...
2. Clone hasil fork, lalu buat virtual environment Python.
3. Baca [Panduan Mahasiswa](PANDUAN_MAHASISWA.md) dan [Pengantar Kuliah](PENGANTAR_KULIAH.md).
4. Ikuti slide pada folder [`slides/`](slides/).
5. Jalankan proyek referensi pada folder [`simulation/`](simulation/).
6. Kerjakan jalur yang disepakati pada [`proyek_adaptasi/`](proyek_adaptasi/) atau [`proyek_orisinal/`](proyek_orisinal/).
7. Tulis hasilnya menggunakan [`paper_akhir_template.qmd`](paper_akhir_template.qmd).
